"Contains all the utils for the clock"
...
class Clock():
    ...
    @staticmethod
    def get_words():
        "Return leds that should be powerered for specific words"
    ...
    def get_led_for_word(word, is_minutes):
        "Return leds that should be powerered for a single specific word"
